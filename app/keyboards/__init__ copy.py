...
from .static_kbs import (drink_order_btn_text, profile_btn_text,
                         i_am_admin_btn_text, add_order_manually_btn_cb,
                         confirm_btn_cb, reject_btn_cb,
                         start_location_tracking, stop_location_tracking)
...
from .static_kbs import tracking_start_kb, tracking_stop_kb
